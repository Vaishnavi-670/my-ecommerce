...
import { ShoppingCart, UserCircle, Search, Star, CreditCard, Package, Heart, Tag } from "lucide-react";
    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <header className="w-full bg-gradient-to-r from-indigo-700 to-purple-700 text-white shadow-md">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
          <div className="text-2xl font-bold text-yellow-300">ShopEase</div>
      ...
      {/* Hero */}
      <section className="w-full h-[500px] pt-24 flex flex-col items-center justify-start text-center">
        <h3 className="px-4 py-2 rounded-full bg-indigo-100 text-[17px] text-indigo-700 font-medium">
          Over 10,000 products, unbeatable deals!
        </h3>

        <h1 className="text-[60px] leading-[70px] font-bold text-gray-900 mt-5">
          Your one-stop shop <br /> for everything you love
        </h1>

        <h4 className="text-[20px] font-medium text-gray-600 mt-5">
          Discover the latest trends, top brands, and exclusive offers—all in one place.
        </h4>

        <button className="mt-6 px-8 py-3 text-[17px] font-semibold rounded-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white hover:from-purple-700 hover:to-indigo-700 transition-all duration-300">
          Shop Now
        </button>
      </section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredProducts.map((product) => (
              ...
              >
                ...
                <button className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-4 py-2 rounded-lg hover:from-purple-700 hover:to-indigo-700 transition mt-auto">
                  Add to Cart
                </button>
              </div>
            ))}
      ...
      <section className="relative w-full h-96 bg-gradient-to-r from-pink-100 via-purple-100 to-blue-100 overflow-hidden rounded-2xl shadow-lg">
      {/* Floating E-commerce Icons */}
      <motion.div
        className="absolute top-10 left-10 text-pink-600"
        animate={{ y: [0, -20, 0] }}
