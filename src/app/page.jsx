  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <section className="relative w-full h-96 bg-gradient-to-r from-pink-100 via-purple-100 to-blue-100 overflow-hidden rounded-2xl shadow-2xl">
        <motion.div className="absolute top-20 right-20 text-blue-600" animate={{ y: [0, 20, 0] }} transition={{ repeat: Infinity, duration: 4 }}>
          <CreditCard size={50} />
        </motion.div>
        <motion.div className="absolute top-20 left-20 text-red-600" animate={{ y: [0, 20, 0] }} transition={{ repeat: Infinity, duration: 4 }}>
          <ShoppingCart size={50} />
        </motion.div>
        <motion.div className="absolute bottom-20 left-1/3 text-green-600" animate={{ y: [0, -25, 0] }} transition={{ repeat: Infinity, duration: 5 }}>
          <Package size={50} />
        </motion.div>
        <motion.div className="absolute top-32 left-1/2 text-red-500" animate={{ y: [0, 15, 0] }} transition={{ repeat: Infinity, duration: 3.5 }}>
          <Heart size={50} />
        </motion.div>
        <motion.div className="absolute bottom-10 right-1/3 text-yellow-500" animate={{ y: [0, -30, 0] }} transition={{ repeat: Infinity, duration: 6 }}>
          <Tag size={50} />
        </motion.div>
      ...
      <footer className="bg-gradient-to-r from-indigo-700 via-purple-700 to-indigo-800 text-white mt-10">
        <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-10">
          {/* Brand Section */} <div>
            ...
            <p className="text-sm text-gray-200"> Your trusted destination for top brands, best prices, and fast delivery. </p>
          </div> {/* Quick Links */} <div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm"> <li>
              <a href="/category/electronics" className="hover:text-yellow-300">Electronics</a></li>
          ...
          <div>
            ...
            <form className="flex flex-col space-y-3">
              <input type="email" placeholder="Enter your email" className="px-3 py-2 rounded-lg border border-gray-500 bg-white/10 text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-yellow-400" />
              <button type="submit" className="bg-yellow-400 text-indigo-900 py-2 rounded-lg font-semibold hover:bg-yellow-300 transition" > Subscribe </button>
            </form> </div> </div>
        {/* Bottom Section */}
        <div className="border-t border-indigo-500 mt-8 py-4 text-center text-sm flex flex-col md:flex-row items-center justify-between px-6 text-gray-200">
          ...
          <div className="flex space-x-5 mt-3 md:mt-0">
            {/* Social Icons */} <a href="#" className="hover:text-yellow-300">
            ...
            </a> <a href="#" className="hover:text-yellow-300">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"> <path d="M12 2.04c-5.52 0-10 4.48-10 10 0 4.42 3.61 8.06 8 8.71V14.9H7.9v-2.86h2.1v-2.19c0-2.1 1.24-3.26 3.14-3.26.91 0 1.85.16 1.85.16v2.04H14c-1.04 0-1.36.64-1.36 1.29v1.95h2.31l-.37 2.86h-1.94v5.85c4.39-.65 8-4.29 8-8.71 0-5.52-4.48-10-10-10z" /> </svg> </a>
            <a href="#" className="hover:text-yellow-300">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"> <path d="M12 2.04c-5.5 0-9.96 4.46-9.96 9.96 0 4.41 3.58 8 8 8.72v-6.16h-2.4V12h2.4v-1.68c0-2.38 1.44-3.68 3.55-3.68 1 0 2.06.18 2.06.18v2.28h-1.16c-1.14 0-1.5.71-1.5 1.43V12h2.56l-.41 2.56h-2.15v6.16c4.42-.72 8-4.31 8-8.72 0-5.5-4.46-9.96-9.96-9.96z" /> </svg>
            </a>
          </div>
        </div>
      </footer>
